...
class Controller {
  constructor (options) {
    ...
    // Simulate the event object structure the Processor expects
    ...
    node.onaudioprocess = (event) => {
      ...
      this.processor.message({ data: { type: 'process', input: channels } });
    };
